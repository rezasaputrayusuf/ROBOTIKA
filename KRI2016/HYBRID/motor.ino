...
//int EIN1 = 38; //Direction
//int EIN2 = 39; //Direction
...
void movee(int motor, int speed, int direction){
...
//M digitalWrite(STBY5, HIGH); //disable standby
...
void majuu(){
  movee(1, 100, 0); //motor 1, full speed, left
  movee(2, 100, 0); //motor 2, full speed, left
  movee(3, 100, 0); //motor 1, full speed, left
  movee(4, 100, 0); //motor 2, full speed, left
  movee(5, 255, 0); //motor 2, full speed, left
}
